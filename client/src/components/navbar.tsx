              ...
              <SheetContent side="right" className="w-[300px] animate-slide-in-right">
                <div className="flex flex-col space-y-6 mt-6">
                  ...
                  <Link href="/wishlist" onClick={() => setIsMobileMenuOpen(false)}>
                    <span className={`text-lg font-medium text-foreground smooth-transition cursor-pointer block py-2 px-3 rounded-lg ${isActive("/wishlist") ? "text-primary bg-primary/5 font-semibold" : "hover:text-primary hover:bg-accent/10 active:scale-95"}`}>
